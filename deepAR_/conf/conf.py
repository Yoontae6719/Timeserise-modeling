...
class Conf(object):
    ...
    def __init__(self, conf_file_path=None, seed=None, exp_name=None, log=True):
        ...
        self.predict_batch = y.get("predict_batch", 256)
        self.train_window = y.get("train_window", 192)
        self.test_window = y.get("test_window", 192)
